...
tempdir = '/home/ermadmix/hy_projs/diggit-hydra/'
obj = ComplexParent.new
#obj.label = "oid:" + "12345" + " cid:" + "1"
obj.label = "test Om indexing"
...
puts "len:"+file.size.to_s
puts "dsB:"+obj.datastreams.inspect
obj.add_file_datastream(file,:controlGroup=>'M',:mimeType=>'text/xml',:dsid=>'descMetadata')
puts "dsA:"+obj.datastreams.inspect
